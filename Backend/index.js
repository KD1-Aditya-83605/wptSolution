...
const jwtSecret = 'whyexamonelectionday';
...
// token of vrushabh eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJwYXNzd29yZCI6InZydTEyMyIsImlkIjoyLCJpYXQiOjE3MTUwODY1Mzl9.0li2WWCOndb1_f-wTxv0wQHwN_ADIysyYfhyXKNDLPs
    ...
    connection.query(queryText,(err,result)=>{
        try{
            ...
            if(JSON.stringify(result) == '[]'){
                ...
                res.json("Sorry you have already voted")
